...
const CosmicConnection = () => {
  ...
  const cosmicIdentities = [
    ...
    'Kuda Bintang: Cepat lari, cepat juga move on',
    'Kambing Kosmik: Suka ngumpet, tapi kalau muncul, bikin heboh',
    'Burung Hantu Nebula: Bijaksana di malam hari, tidur di siang hari',
    'Rusa Bima Sakti: Lincah dan indah, tapi sering overthinking',
    'Ikan Paus Antariksa: Besar hatinya, besar juga tagihan makanannya',
    'Banteng Aurora: Keras kepala tapi punya prinsip kuat',
    'Singa Supernova: Aura pemimpin, tapi takut kecoa',
    'Rubah Konstelasi: Cerdik dan misterius, jago bikin konspirasi',
    'Kelinci Asteroid: Cepat bergerak, cepat juga baper',
    'Buaya Bintang: Jago merayu, lebih jago lagi menghilang',
    'Kura-kura Kosmik: Lambat tapi pasti, terutama balas chat',
    'Kungkang Galaxy: Santai sepanjang masa, tidak kenal deadline',
    'Musang Meteor: Manis di depan, licik di belakang',
    'Beruang Kutub Orbital: Dingin di luar, hangat di dalam',
    'Kadal Konstelasi: Bisa beradaptasi di mana saja, kecuali di hati mantan',
    'Siput Nebula: Lambat memulai, lambat juga selesainya',
    'Lebah Galaksi: Sibuk terus, tapi hasil manisnya buat orang lain',
    'Semut Bintang: Kecil-kecil cabe rawit, kecil juga gajinya',
    'Jerapah Kosmik: Melihat jauh ke depan, tapi sering nyaris nabrak tiang',
    'Sigung Antariksa: Suka menyendiri, kalau diganggu bikin semua kabur'
  ];
  ...
  const generateCompatibility = () => {
    ...
    const haikus = [
      ...
      `Dua bintang bersinar\nBagai gorengan dan sambal\nPedas tapi bikin nagih`,
      `Seperti bakso cinta\nKenyal di luar, lembut di dalam\nBikin ketagihan terus`,
      `Bagai martabak manis\nDi luar renyah, di dalam lumer\nBikin hati meleleh`,
      `Kayak es campur cinta\nMacem-macem jadi satu\nSegar sepanjang masa`,
      `Bagai soto dan emping\nBeda rasa jadi nikmat\nMakin enak bersama`,
      `Cinta bagai rendang\nMakin lama makin enak\nAwet sampai tua`,
      `Seperti nasi uduk\nSederhana tapi nikmat\nSelalu bikin kangen`,
      `Bagai kerak telor\nButuh api besar untuk matang\nTapi worth it banget`,
      `Dua zodiak ini\nSperti cilor dan mayones\nMesra tak terpisahkan`,
      `Kayak kopi dan senja\nHangat di hati dan jiwa\nMoment yang sempurna`
    ];
    ...
    return (
      <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center p-4 text-center">
        <div className="animate-float">
          ...
          <p className="text-xl mb-6 text-white/80">Ramalan Zodiak Ala Mamang Dukun</p>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-black text-white p-4 relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto relative z-10">
        <header className="text-center mb-8 mt-4">
          ...
          <p className="text-lg opacity-80">Ramalan Zodiak Ala Mamang Dukun</p>
        </header>
        ...
        <footer className="text-center text-sm opacity-60 mt-8 mb-4">
          ...
          <p className="mt-2 text-xs">Made with ❤️ by Coim</p>
        </footer>
      </div>
    </div>
  );
